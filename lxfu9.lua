...
lxfu9_Msg = 'غير متفاعل ⚡️' 
elseif msgs < 400 then 
lxfu9_Msg = 'استمر بطل 💫' 
elseif msgs < 700 then 
lxfu9_Msg = 'ملك التفاعل 🌙' 
elseif msgs < 1200 then 
lxfu9_Msg = 'اسد التفاعل ✨' 
elseif msgs < 2000 then 
lxfu9_Msg = 'اقوى تفاعل 🔥' 
elseif msgs < 3500 then 
lxfu9_Msg = 'اجمل تفاعل 💥'  
elseif msgs < 4000 then 
lxfu9_Msg = 'تفاعل روعه 🌜' 
elseif msgs < 4500 then 
lxfu9_Msg = 'التفاعل المثالي ⭐️' 
elseif msgs < 5500 then 
lxfu9_Msg = 'اقوى متفاعل 😎' 
elseif msgs < 7000 then 
lxfu9_Msg = 'ملك التفاعل 🤹‍♂️' 
elseif msgs < 9500 then 
lxfu9_Msg = 'امبروطور التفاعل 🧛‍♂️' 
elseif msgs < 10000000000 then 
lxfu9_Msg = 'رب التفاعل 👨‍🚒'  
end 
return lxfu9_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function Devlxfu9(msg,data) -- Source lxfu9 
if msg then
...
Devlxfu9r = '🌐┋مرحبا بك في بوت الحمايه'..'\n🎫┋آنا آختصاصي حمايه المجموعات'..'\n📛┋مـن آلسـبآم وآلتوجيهہ‌‏ وآلتگرآر وآلخ...'..'\n\n📨┋ارسل ما تريد وسارسله الى المطور'..'\n\n📡┋[Channel lxfu9](t.me/lxfu9)'
end 
send(msg.chat_id_, msg.id_, Devlxfu9r) 
end
end
...
usertext = '\n👤┋المستخدم » ['..result.title_..'](t.me/'..(username or 'lxfu9')..')'
...
usertext = '\n👤┋المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'lxfu9')..')'
status  = '\n🔅┋ تم ترقيتهہ‌‏ مطور في البوت'
...
send(msg.chat_id_,0,"👤┋المستخدم : {["..data.first_name_.."](T.ME/lxfu9)}\n📛┋["..lxfu9_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_, msg.id_,'♻┋ تم تحديث السورس \n👤┋ مــن قـبـل ⊰• ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'lxfu9')..')') 
dofile('lxfu9.lua')  
end
...
Text = [[
🔰┇Welcome to lxfu9 source
      ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
↬   [Install source](https://t.me/lxfu9/1111)

↬   [Channel lxfu9](http://t.me/lxfu9)

↬   [Group lxfu9®](https://t.me/joinchat/GLOSYU6g4O3LbQTRqyEZxg)
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'👤┋ مــن قـبـل ⊰• ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'lxfu9')..') \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n📌┋ تـم قفـل الدردشه ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤┋ مــن قـبـل ⊰• ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'lxfu9')..')\n📌┋ تـم قفـل التاك بالكتم')  
end,nil)   
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👤┋المستخدم » ['..result.title_..'](t.me/'..(text1[3] or 'lxfu9')..')'..'\n📬┋ تم رفعهہ‌‏ '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
local Json_config = JSON.decode(lxfu9)
